...
/*   Updated: 2021/06/29 13:50:24 by dzonda           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "ft_base64.h"

void ft_b64_enc_pad(unsigned char *dst, size_t dst_len, size_t src_len, int *idst) {
  int pad;
...
void  ft_b64_enc_block(unsigned char *dst, t_uint32 block, int i, int *idst) {

...
/*   Updated: 2021/07/14 15:17:20 by dzonda           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_des_permute_ip1(ubyte mp[8], const t_uchar *msg) {
    int i, j;
...
void    ft_des_permute_ip2(char *cipher, ubyte e[8]) {
    int i, j;

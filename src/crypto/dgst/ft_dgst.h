...
typedef     int     t_dgst_init(t_dgst_ctx *, unsigned int);
typedef     int     t_dgst_pre_process(t_dgst_ctx *, uint8_t *, unsigned int);
typedef     int     t_dgst_process(t_dgst_ctx *);
typedef     char*   t_dgst_final(t_dgst_ctx *, char *);

...
// /*   Updated: 2021/02/23 18:46:56 by dzonda           ###   ########lyon.fr   */
// /*                                                                            */
// /* ************************************************************************** */
...
// typedef enum	e_dgst_version_prop
// {
...
// typedef union	u_digest_state
// {
// 	uint32_t	x_32[8];
// 	uint64_t	x_64[8];
// }				t_dgst_st;

// typedef union	u_digest_words
// {
// 	uint32_t	x_32[80];
// 	uint64_t	x_64[80];
// }				t_dgst_words;

// typedef union	u_digest_length
// {
// 	uint64_t	x_32;
// 	__uint128_t	x_64;
// }				t_dgst_len;
...
// typedef int		t_dgst_init(t_dgst_ctx *ctx, unsigned int msg_len);
// typedef int		t_dgst_pre_process(t_dgst_ctx *ctx, uint8_t *msg,
// 						unsigned int len);
// typedef int		t_dgst_process(t_dgst_ctx *ctx);
// typedef char*	t_dgst_final(t_dgst_ctx *ctx, char *md);
...
// int				ft_sha384_pre_process(t_dgst_ctx *ctx, uint8_t *msg,
// 										unsigned int msg_len);

...
/*   Updated: 2021/08/05 20:37:02 by dzonda           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
# define FT_SSL_DES_ENC	0
# define FT_SSL_DES_DEC	1
...
typedef int				t_ssl_des_ft(char *key, char *msg, int msg_len, char **cipher);
...
typedef struct			s_ssl_des_dispatch
{
	int							mode;
	t_ssl_des_ft		*des_mode;
}						t_ssl_des_d;

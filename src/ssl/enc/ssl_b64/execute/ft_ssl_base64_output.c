...
/*   Updated: 2021/08/09 08:46:38 by user42           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
//       {FT_SSL_BASE64_ENCODE, ft_b64_encode},
//       {FT_SSL_BASE64_DECODE, ft_b64_decode},
//   };
//   char *msg = NULL;
//   int msg_len = 0;
...
//   // printf("msg: %s\n", msg);
//   // printf("msg_len: %d\n", msg_len);
//   if (msg == NULL || msg_len < 1) return (EXIT_FAILURE);
...
//   // free(&buffer);
//   ft_strdel(&buffer);
//   if (ctx->opt.output != NULL) close(fd);
